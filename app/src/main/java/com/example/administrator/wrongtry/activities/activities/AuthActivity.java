...
public class AuthActivity extends Activity implements OnClickListener{
    ...
    public static boolean passwd1ButtonClickFlag;
    ...
    private Handler mHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 1:
                    if(passwd1ButtonClickFlag == true) {
                        passwd1Button.performClick();
                        passwd1ButtonClickFlag = false;
                    }
                    break;
                default:
                    break;
