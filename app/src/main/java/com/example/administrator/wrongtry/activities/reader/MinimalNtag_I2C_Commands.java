...
public class MinimalNtag_I2C_Commands extends I2C_Enabled_Commands {
	...
	private final int firstSectorMemsize = (0xFF - 0x4) * 4;//See P12
	...
	public MinimalNtag_I2C_Commands(Tag tag, Prod prod) throws IOException {
		tagType = prod;
		blockSize = 4;//Ĭ��Page��СΪ4�ֽ�
		SRAMSize = 64;//Ĭ��SRAM��СΪ64�ֽ�
		this.mfu = MifareUltralight.get(tag);//ͨ��get����һ��MifareUltralight����
	}
	...
	public byte[] getSessionRegisters() throws IOException, FormatException,
		...
		answer = mfu.readPages(0xEC);//Session registers���ڵ���ʼPage��ַ
		return answer;
	}
	...
	public byte[] getConfigRegisters() throws IOException, FormatException,
		...
		answer = mfu.readPages(0xE8);//Configuration registers���ڵ���ʼPage��ַ
		return answer;
	}
	...
	public void writeConfigRegisters(byte ncR, byte ldR, byte smR,
		...
		data[0] = ncR;//NC_REG
		data[1] = ldR;//LAST_NDEF_BLOCK
		data[2] = smR;//SRAM_MIRROR_BLOCK
		data[3] = wdLsR;//WDT_LS
		mfu.writePage(0xE8, data);//Configuration registers���ڵ���ʼPage��ַ

		data[0] = wdMsR;//WDT_MS
		data[1] = i2CClockStr;//I2C_CLOCK_STR
		data[2] = (byte) 0x00;//REG_LOCK
		data[3] = (byte) 0x00;//RFU
		mfu.writePage(0xE9, data);//Configuration registers���ڵĵڶ���Page��ַ
	}
	...
	public void writeEEPROM(byte[] data, WriteEEPROMListener listener) throws IOException, FormatException,
		...
		byte[] temp;
		int blockNr = Register.User_memory_Begin.getValue();//0x04
	 ...
	 */
	@Override
	//absStart��absEnd��Page address���ĵ�λ��ͬ
